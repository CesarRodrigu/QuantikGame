	...
	public static void main(String[] args) {
		...
		try {
			...
			do {
				...
				while ((!jugada.equalsIgnoreCase("salir") && !jugada.equalsIgnoreCase("deshacer"))
						&& (validarFormato(jugada) != true || validarLegalidad(jugada) == false)) {

					while ((!jugada.equalsIgnoreCase("salir") && !jugada.equalsIgnoreCase("deshacer"))
							&& validarFormato(jugada) != true) {
					...
					if (jugada.equalsIgnoreCase("salir") || jugada.equalsIgnoreCase("deshacer")) {
						break;
					}
				}
				if (jugada.equalsIgnoreCase("salir")) {
					mostrarInterrupcionPartida();
					break;
				} else {
					if (jugada.equalsIgnoreCase("deshacer")) {
						deshacer.deshacerJugada();
						partida = deshacer.consultarPartidaActual();
					} else {
						realizarJugada(jugada);
						avanzarTurno();
//						if (comprobarSiFinalizaPartida() == false) {
//						}
					}
				}
			} while (comprobarSiFinalizaPartida() == false);
	 ...
	 * @throws IllegalArgumentException si el argumento con el modo de deshacer no
	 *                                  es correcto
	 */
